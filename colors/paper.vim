...
" License: MIT
" Origin: http://github.com/ashfinal/vim-colors-paper.git
"
" Modified from the theme 'PaperColor'
...
if s:is_dark " DARK VARIANT
    ...
    " Statusline:
    let s:statusline_active_fg   = ['#eeeeee', '255']
    let s:statusline_active_bg   = ['#444444', '238']
    let s:statusline_inactive_fg = ['#121212', '233']
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call s:HL("VertSplit", s:divider, s:divider, "none")
